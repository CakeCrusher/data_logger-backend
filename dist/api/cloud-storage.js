...
var storage = new googleStorage.Storage({ keyFilename: './voice-logger-key.json' });
var bucket = storage.bucket('speeches_to_transcribe');
...
var deleteFile = function (fileName) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bucket.file(fileName)];
            case 1:
                fileToDelete = _a.sent();
                return [4 /*yield*/, fileToDelete.delete()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
