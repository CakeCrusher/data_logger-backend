...
var _a = require('./cloud-storage'), uploadFile = _a.uploadFile, deleteFile = _a.deleteFile;
var transcribeRecording = require('./cloud-speech').transcribeRecording;
var transcriptionHandler = require('./transcription-handler').transcriptionHandler;
var app = express();
...
var createM4AFile = function (m4aStringified) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fs.writeFileSync('./assets/toTranscribe.m4a', m4aStringified, { encoding: 'base64' }, function (err) { console.error(err); })];
            case 1:
                _a.sent();
                console.log('File downloaded');
                return [2 /*return*/, './assets/toTranscribe.m4a'];
        }
    });
}); };
var deleteFileLocally = function (fileName) {
    fs.unlink("./assets/" + fileName, function (err) {
        if (err) {
...
var transcribe = function (fileName) { return __awaiter(void 0, void 0, void 0, function () {
    var convertedFilePath, convertedFileName, gcsURI, transcription;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, linear16("./assets/" + fileName, "./assets/" + fileName.split('.')[0] + ".raw")];
            case 1:
...
app.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var m4aStringified, transcription, stringifiedTranscription, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                m4aStringified = req.body.audioBase64;
                if (!req.body.test) return [3 /*break*/, 2];
                console.log('Test');
                return [4 /*yield*/, fs.readFileSync('./assets/audioBase64-example.txt', { encoding: 'base64' })];
            case 1:
                // To load a specific audio string
                m4aStringified = _a.sent();
                _a.label = 2;
            case 2: return [4 /*yield*/, createM4AFile(m4aStringified)];
            case 3:
                _a.sent();
